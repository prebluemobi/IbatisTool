...
public class ConnetionUtils {
	public static Connection getConnetion() throws Exception {
		String diver = ProReader.getInstance().getProperty("database.driverClassName");
		String url = ProReader.getInstance().getProperty("database.url");
		String user = ProReader.getInstance().getProperty("database.username");
		String password = ProReader.getInstance().getProperty("database.password");
		Class.forName(diver);
	...
	public static Column getCloum(ResultSet rs) throws Exception {
		...
		c.setCloumNameU(StringUtility.getCamelCaseString(cloumName, true));
