...
<body>
	...
	<div id="content" region="center" title="列表" style="padding:5px;">
		<table id="dg" class="easyui-datagrid"
			style="width:98%;min-height:400px" url="discover/userInfoAjaxPage.do"
			iconCls="icon-save" rownumbers="true" pagination="true"
			singleSelect="true" toolbar="#toolbar">
			<thead>
				<tr>
					<th field="id" align="center" width="200"></th>
					<th field="name" align="center" width="200"></th>
					<th field="age" align="center" width="200"></th>
					<th field="sex" align="center" width="200"></th>
				</tr>
			</thead>
		</table>
		<div id="toolbar">
			...
			<div style="margin-bottom:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					...
					onclick="doDelete('discover/userInfoAjaxDelete.do')">删除</a>
			</div>
		</div>
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" name="fm" method="post" action="discover/userInfoAjaxSave.do"
				...
				<div class="fitem">
					<label>:</label> <input id="name" name="name"
						style="width: 200px" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
					<label>:</label> <input id="age" name="age"
						style="width: 200px" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
					<label>:</label> <input id="sex" name="sex"
						style="width: 200px" class="easyui-textbox" required="true">
				</div>
			</form>
		</div>
